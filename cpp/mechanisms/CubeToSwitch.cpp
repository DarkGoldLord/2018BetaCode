...
CubeToSwitch::CubeToSwitch() : m_controller( TeleopControl::GetInstance() ),
							   m_lift( nullptr )
{
...
// Returns:         void
//-----------------------------------------------------------------------------------
ICubeHandler::CURRENT_CUBEHANDLER_STATE CubeToSwitch::Periodic()
{
	ICubeHandler::CURRENT_CUBEHANDLER_STATE state = ICubeHandler::MOVE_TO_SWITCH_POS;
