...
ArcadeDrive::ArcadeDrive() : IDrive()
{
	...
	TeleopControl::GetInstance()->SetAxisProfile(TeleopControl::ARCADE_DRIVE_STEER, IDragonGamePad::AXIS_PROFILE::CUBED );
	TeleopControl::GetInstance()->SetAxisScaleFactor(TeleopControl::ARCADE_DRIVE_STEER, 0.85 );
	TeleopControl::GetInstance()->SetAxisProfile(TeleopControl::ARCADE_DRIVE_THROTTLE, IDragonGamePad::AXIS_PROFILE::CUBED );
}
